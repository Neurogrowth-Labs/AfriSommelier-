...
-- =========================================================================
-- 6. PRODUCTION DATA POLICY
-- =========================================================================
-- Cupido profiles are created by authenticated users through onboarding.
-- This schema intentionally avoids inserting synthetic dating profiles.
